...
class ProcessExecutor {
     ...
     */
    ProcessExecutor withOutput(OutputStreamSpec spec, File standardOutput, File standardError, Action<OutputStreamConfiguration> configure = null) {
     ...
     */
    ProcessExecutor withOutput(OutputStreamSpec spec, File file, Action<OutputStreamConfiguration> configure = null) {
     ...
     */
    ProcessExecutor withOutputLogFile(OutputStreamSpec outputStreamSpec,
                                      LogFileSpec stdout,
                                      LogFileSpec stderr,
